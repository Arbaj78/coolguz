      ...
      <div className="min-h-screen bg-black relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-20">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl mb-6 shadow-lg shadow-orange-500/25">
          ...
          <div className="max-w-4xl mx-auto space-y-4">
            {faqs.map((faq) => {
              ...
              return (
                <div
                  key={faq.id}
                  className="group relative bg-black/90 backdrop-blur-sm border border-gray-700/50 rounded-2xl overflow-hidden transition-all duration-500 hover:border-orange-500/50 hover:shadow-2xl hover:shadow-orange-500/10"
                >
                  <div className="absolute inset-0 bg-black opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>

                  <button
                    onClick={() => toggleItem(faq.id)}
                    className="w-full p-6 md:p-8 text-left relative z-10 focus:outline-none focus:ring-2 focus:ring-orange-500/50 rounded-2xl"
                  >
                      ...
                      <div className="flex items-center space-x-4 flex-1">
                        <div
                          className={`flex items-center justify-center w-12 h-12 rounded-xl transition-all duration-300 ${
                            isOpen
                              ? 'bg-black shadow-lg shadow-orange-500/25'
                              : 'bg-black group-hover:bg-gradient-to-r group-hover:from-orange-600/80 group-hover:to-amber-600/80'
                          }`}
                        >
                          <IconComponent
                        ...
                        <h3 className="text-lg md:text-xl font-semibold text-white group-hover:text-orange-200 transition-colors duration-300 pr-4">
                          {faq.question}
                        </h3>
                      </div>

                      <ChevronDown
                        className={`w-6 h-6 text-gray-400 group-hover:text-orange-400 transition-all duration-300 flex-shrink-0 ${
                  ...
                  >
                    <div className="px-6 md:px-8 pb-6 md:pb-8 relative z-10">
                      <div className="ml-16 pt-2 border-l-2 border-gradient-to-b from-orange-500/50 to-amber-500/50 pl-6">
                  ...
                  <div
                    className={`h-0.5 bg-black from-transparent via-orange-500 to-transparent transition-opacity duration-500 ${
          ...
          <div className="text-center mt-16">
            <div className="inline-flex items-center justify-center space-x-2 px-6 py-3 bg-black backdrop-blur-sm border border-orange-500/30 rounded-full text-orange-200 hover:from-orange-600/30 hover:to-amber-600/30 transition-all duration-300 hover:shadow-lg hover:shadow-orange-500/25">
