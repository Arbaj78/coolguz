...
const ContactPage = () => {
  ...
  return (
    <div className="relative overflow-hidden min-h-screen">
      <Helmet>
        <title>Contact FatCamel AI — Let’s Build Something Smart</title>
        <meta
          name="description"
          content="Get in touch with FatCamel AI for automation consulting, partnerships, and AI-powered workflow solutions."
        />
            ...
            <div className="bg-white rounded-xl p-8 shadow-lg border border-blue-100 hover:border-orange-300 transition-all">
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-blue-50 border border-blue-200 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 text-black"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-amber-500 text-white py-3 px-6 rounded-lg font-semibold hover:from-orange-600 hover:to-amber-600 transition-all shadow-md disabled:opacity-70 flex items-center justify-center"
                >
                  {status === "Sending..." ? (
                    <>
                      <svg
