...
const BlogPosts = () => {
  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden">
          ...
          {showSearch && (
            <div className="relative mb-4 animate-slide-down">
              <input
                ...
                className="w-full max-w-md mx-auto block py-3 pl-4 pr-4 bg-white border-2 border-gray-200 rounded-full focus:outline-none focus:ring-2 focus:ring-orange-100 focus:border-orange-500 text-black placeholder:text-gray-400 shadow-lg transition-all duration-300"
                value={searchTerm}
      ...
      {/* Local styles */}
      <style>{`
        @keyframes blob { 0% { transform: translate(0px, 0px) scale(1); } 33% { transform: translate(20px, -30px) scale(1.1); } 66% { transform: translate(-15px, 15px) scale(0.9); } 100% { transform: translate(0px, 0px) scale(1); } }
